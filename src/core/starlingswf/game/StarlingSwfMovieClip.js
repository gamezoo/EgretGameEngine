 ...
 */
var StarlingSwfMovieClip = /** @class */ (function (_super_1) {
    __extends(StarlingSwfMovieClip, _super_1);
    /**
     * 构造函数
     * @param frames
     * @param labels
    ...
    function StarlingSwfMovieClip(frames, labels, displayObjects, ownerSwf) {
        var _this = _super_1.call(this, frames, labels, displayObjects, ownerSwf) || this;
        _this.frameActions = {};
        _this.preFrame = -1;
    ...
    StarlingSwfMovieClip.prototype.setCurrentFrame = function (frame) {
        _super_1.prototype.setCurrentFrame.call(this, frame);
